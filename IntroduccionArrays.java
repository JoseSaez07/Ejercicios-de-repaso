public class mostrarTemperaturas {
    ...
    String[] paises = new String[5];paises[0]="Afganistan";paises[1]="España";paises[2]="Perú";paises[3]="Colombia";paises[4]="Venezuela";System.out.printf("Paises [0]: %s\n",paises[0]);System.out.printf("Paises [4]: %s\n",paises[4]);System.out.printf("Total de paises: %d\n",paises.length);
    }
}
